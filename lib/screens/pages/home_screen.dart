    ...
    return Scaffold(
      body: Stack(
        children: [
                        ...
                        Container(
                          ...
                          child: DropdownButtonFormField<String>(
                            ...
                            items: const [
                              ...
                              DropdownMenuItem(value: 'Station 3', child: Text('Station 3')),
                            ],
                            onChanged: (value) {
                              setState(() {
          ...
          Positioned(
            left: (screenWidth / 2) - 75, // Center horizontally (button width is 150)
            top: 400 - 25, // Position so that half of the button overlaps blue and gray (button height is 50)
            child: SizedBox(
              width: 150,
              height: 50,
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color(0xFF00509e), // Blue color
